#ifndef __DEVICES_TYPES_H__
#define  __DEVICES_TYPES_H__
...
private:
	...
	typedef map<int, device_signal, ltint> signals_container;
	...
	typedef map<int, device_block, ltint> blocks_container;
