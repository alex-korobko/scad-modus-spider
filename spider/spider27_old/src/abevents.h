...
ApEventLink_t AbInternalLinks[] = {
	...
	{ 4, 0, 0L, 0L, 0L, &DeviceConfig, NULL, NULL, 0, link_setup_EscConfig, 1, 9, 0, 0, },
	{ 0 }
	};
...
static const ApEventLink_t AbLinks_DeviceConfig[] = {
	{ 8, 0, 0L, 0L, 0L, NULL, NULL, "DeviceConfig", 1013, unrealized_EscConfig, 0, 0, 0, 0, },
	...
	{ 8, 3, 0L, 0L, 0L, NULL, NULL, "rwlst_config_devices", 68000, (int(*)(PtWidget_t*,ApInfo_t*,PtCallbackInfo_t*)) draw_escalator_start_item, 0, 0, 0, 0, },
	{ 8, 3, 0L, 0L, 0L, NULL, NULL, "rwlst_config_devices", 68003, (int(*)(PtWidget_t*,ApInfo_t*,PtCallbackInfo_t*)) selection_escalator_start_item, 0, 0, 0, 0, },
	{ 0 }
	};
