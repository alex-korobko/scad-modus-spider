...
void
msg_dict_container::load_message_parameters () throw (spider_exception){
...
entries_names[ID]="id";
entries_names[TYPE]="message type";
...
void
	msg_dict_container::load(string file_name) throw (spider_exception) {
